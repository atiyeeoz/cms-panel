<div class="simple-page-wrap">
    ...
    <div class="simple-page-form animated flipInY" id="login-form">
        <h4 class="form-title m-b-xl text-center">Bilgilerinizle  giriş yapın</h4>
        <form action="<?php echo base_url("userop/do_login"); ?>" method="post">
            ...
            <button type="submit" class="btn btn-primary"style="background-color:black;">Giriş Yap</button>
        </form>
    </div><!-- #login-form -->
